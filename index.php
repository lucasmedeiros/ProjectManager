        ...
        <ul class="nav navbar-nav pull-right">
          <li class="dropdown">
              ...
              <?php 
                ...
                if ($resultadoIsAdmin) {
                  ...
                  while(($administrador = mysqli_fetch_array($administradores)) != null) {
                    ...
                    // Pegando o nome de login (isto será útil)
                  }
                  
                  if ($intAdmin == 1) {
                    $query1 = "select foto from Login where login = '$loginName';";
                    // Selecionando a foto
                    ...
                    if ($result1) {
                      ...
                      while(($foto = mysqli_fetch_array($nomes)) != null) {
                          ...
                          // Exibindo a foto, que se localizará ao lado do nome
                      }
                    }
                  } else {
                    header('Location:indexUsuario.php');
                    // Se o usuário não for administrador, será redirecionado
                  }
                }
              ?>
            ...
            <ul class="dropdown-menu">
              ...
              <!-- Esta variável "logout" será enviada para esta mesma página via "GET", assim possibilitando -->               
            </ul>
          </li>
        </ul>
...
<div class="container" id="tudo">
  ...
  <div class="row">
    ...
    <div class="col-sm-9">
       ...
       <h3>TODOS OS PROJETOS CADASTRADOS</h3>  
         	...
         	<div class="col-md-12">
              ...
              <?php
                ...
                if (!$row) {
                  ...
                  ?>
                    <div class="alert alert-danger">
                      <small><strong>Sem projetos cadastrados...</strong></small>
                    </div>
                  <?php
                } else {
                        ...
                        <div class="panel-body">
                          ...
                          <?php
                            ...
                            if (!$row3) {
                              ?>
                                <div class="alert alert-danger">
                                  <small><strong>Ainda não há participantes cadastrados neste projeto</strong></small>
                                </div>
                              <?php
                            } else {
                                ?>
                                  <table class="table">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        echo "<img src=\"$path\" style=\"border-radius: 50px; width: 40px; height: auto;\"></img>"; ?></td>
                                        <td><?php
                                          echo $part['nomeCompleto'];?></td>
                                        <td><?php 
                          ...
                          ?>
                          <hr style="border: 1px solid #ccc;"/>
                          <h4 align="center"><strong>Objetivos:</strong></h4>
                          <?php
                            ...
                            if (!$row4) {
                              ?>
                                <div class="alert alert-danger">
                                  <small><strong>Ainda não há objetivos cadastrados neste projeto</strong></small>
                                </div>
                              <?php
                            } else {
                          ...
                          <a href="objetivo.php" class="btn btn-success pull-left"><i class="glyphicon glyphicon-plus"></i><strong>  OBJETIVO</strong></a>
                          <a class="btn btn-primary pull-right" href="novoParticipante.php"><i class="glyphicon glyphicon-plus"></i><strong>  PARTICIPANTE</strong></a>
                        </div>
                      </div>
                      <?php
                  }
